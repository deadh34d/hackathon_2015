    ...
    <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
            <form action="<?php echo $app_path . '/admin/index.php'; ?>" method="POST" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type='text'
                               ...
                               required="required"
                               pattern="^[a-zA-Z ]+"
                               name="subdivision" value="<?php echo $home['subdivision']; ?>">
                ...
                <div class="form-group">
                    <label for="state" class="col-sm-2 control-label"><i class="state state-ga"></i>&nbsp;State (ex. Georgia)</label>
                ...
                <div class="form-group">
                    <label for="zip" class="col-sm-2 control-label"><i class="zip zip-ga"></i>&nbsp;Zip (ex. 30809)</label>
                    ...
                    <div class="col-sm-10">
                        <input type='text'
                               ...
                               min="1" max="99999"
                               required="required"
                               name="zip" value="<?php echo $home['zip_code']; ?>">
                        <datalist id='zip'>
                            <?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type='text'
                               ...
                               required="required"
                               pattern="^[a-zA-Z0-9 ]+"
                               name="plan_name" value="<?php echo $home['plan_name']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type='text'
                               ...
                               required="required"
                               pattern="^[a-zA-Z]"
                               name="elevation" value="<?php echo $home['elevation']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type='text'
                               ...
                               required="required"
                               pattern="^[a-zA-Z0-9 ]+"
                               name="Finish" value="<?php echo $home['finish']; ?>">
                        <datalist id='finish'>
                            <?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type='text' class="form-control" list='bath' placeholder="Baths" name="bath" required="required"
                               min="1"
                               max="20">
                        <datalist id='bath'>
                            <?php
