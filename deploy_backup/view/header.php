    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo $app_path; ?>"><img
                    src="http://designeroid.com/idk/img/idk-logo-white.png"></a>

        </div>

        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav"> <?php $links = array('home', 'browse', 'about', 'contact', 'careers', 'BuilderTREND-Client-Login', 'testimonials');
                foreach ($links as $link) { ?>
                    <li class="text-center navlink"><a
                        href='<?php echo $app_path . "/" . $link; ?>'> <?php if($link == 'BuilderTREND-Client-Login'){ echo ucwords('BuilderTREND Client Login');}else{ echo ucfirst($link); }?> </a>
                    </li><?php } ?>
            </ul>
