...
<div class="container">
    ...
    <div class="panel panel-default text-center">
        ...
        <?php } ?>
        <div class="panel-heading">
            <div class="panel-title"><?php echo ucwords($page_action); ?> Home</div>
        </div>
        <div class="panel-body">
            <form action="<?php echo $app_path . '/admin/index.php'; ?>" method="POST" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <?php if ($current_sold == '1' || (isset($home['sold']) && $home['sold'] == 1)) {
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type='text' class=" form-control" list='bath' placeholder="Baths" name="baths"
                               ...
                               min="1"
                               max="20"
                            <?php if (isset($home['baths'])) { ?>
                                value="<?php echo $home['baths']; ?>"
                            <?php } ?>
                            >
                        <datalist id='bath'>
                            <?php
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <textarea class="form-control" placeholder="Description" name="description"
                                  id="description"><?php if (isset($home['description'])) {
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type='text' class=" form-control" list='mls'
                            ...
                            <?php if (isset($home['mls'])) { ?>
                                value="<?php echo $home['mls']; ?>"
                            <?php } ?>
                            >
                    </div>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <span class="panel-title">Current Home's Image(s)</span>
                </div>
