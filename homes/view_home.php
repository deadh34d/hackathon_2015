    ...
    <div class="container">
        <div class="row text-center" id="home-description">
            <?php if (isset($home['description']) && !empty($home['description'])) { ?>
                <p><?php echo htmlspecialchars($home['description']); ?></p>
            <?php } ?>
        </div>
    </div>
    <div class="container">
            ...
            <table class="table table-hover text-center">
                <tr>
                    <?php if (isset($home['street_name']) && isset($home['street_number']) && isset($home['state']) &&
                        ...
                        <td id="address">
                            <?php echo htmlspecialchars($home['street_number'] . ' ' . $home['street_name']
                ...
                <tr>
                    <?php if (isset($home['subdivision']) && !empty($home['subdivision'])) { ?>
                        ...
                        <td><?php echo htmlspecialchars($home['subdivision']); ?></td>
                    <?php } ?>
                </tr>
                <tr>
                    <?php if (isset($home['lot']) && !empty($home['lot'])) { ?>
                        ...
                        <td> <?php echo htmlspecialchars($home['lot']); ?></td>
                    <?php } ?>
                </tr>
                <tr>
                    <td>Availability</td>
                ...
                <tr>
                    <?php if (isset($home['plan_name']) && !empty($home['plan_name'])) { ?>
                        ...
                        <td><?php echo htmlspecialchars($home['plan_name']); ?></td>
                    <?php } ?>
                </tr>
                <tr>
                    <?php if (isset($home['sales_price']) && !empty($home['sales_price'])) { ?>
                        ...
                        <td><?php echo htmlspecialchars($home['sales_price']); ?></td>
                    <?php } ?>
                </tr>
                <tr>
                    <?php if (isset($home['elevation']) && !empty($home['elevation'])) { ?>
                        ...
                        <td><?php echo htmlspecialchars($home['elevation']); ?></td>
                    <?php } ?>
                </tr>
                <tr>
                    <?php if (isset($home['finish']) && !empty($home['finish'])) { ?>
                        ...
                        <td><?php echo htmlspecialchars($home['finish']); ?></td>
                    <?php } ?>
                </tr>
                <tr>
                    <?php if (isset($home['mls']) && !empty($home['mls'])) { ?>
                        <td>MLS Listing Page</td>
                        <td><a href="<?php echo htmlspecialchars($home['mls']); ?>">Link</a></td>
                    <?php } ?>
                </tr>
                <tr>
