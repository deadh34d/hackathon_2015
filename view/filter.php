    ...
    <div class="panel-body">
        <form action="<?php echo $app_path . '/browse'; ?>" method="post" role="form" id="filter">
            ...
            <div class="table-responsive">
                <table class="table">
                    <tr>
                        <td><label for="price-from"><i class="fa fa-money hidden-xs"></i>&nbsp;Price:</label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="sqft-from"><i class="fa fa-square hidden-xs"></i>&nbsp;Square Feet:
                            </label></td>
                        <td>
                            <select id="sqft-from" name="min_sqft">
                                ...
                                foreach ($sqfts as $sqft) {
                                    ...
                                    <?php } else { ?>
                                        <option
                                            value="<?php echo $sqft['sqft']; ?>"><?php echo $sqft['sqft']; ?></option>
                                    <?php }
                                } ?>
                            </select>
                    ...
                    <tr>
                        <td><label for="bedrooms-from"><i class="fa fa-bed hidden-xs"></i>&nbsp;Bedrooms: </label></td>
                        <td>
                    ...
                    <tr>
                        <td><label for="location"><i class="state state-ga hidden-xs"></i>&nbsp;Location:</label></td>
                        <td>
                            <select id="location" name="location">
                                ...
                                foreach ($locations as $location) { //TODO: Fix this dirty state manipulation
                                    if(strtolower($location['state']) == strtolower('Georgia')){
                                        $location['state'] = 'GA';
                                    }elseif(strtolower($location['state']) == strtolower('South Carolina')){
                                        $location['state'] = 'SC';
                                    }
