<div class="col-xs-12 text-center">
    <span class="text-block"> &copy 2015 <a href="mailto:john@designeroid.com">Designeroid</a>
        <b>|</b>
        <?php if (isset($_SESSION['user'])){ ?>
        <a href="<?php echo $app_path; ?>/admin/">Admin Panel</span>
    <?php } ?>
    <b>|</b>
    <a href="<?php echo $app_path . '/privacy'; ?>">Privacy Policy</a>
</div>
</div>
...
<!--SumoMe-->
<script src="//load.sumome.com/" data-sumo-site-id="763d29a3a24d265ceb9d9339581c8804c4da5cb049e950eaae4604431a699d20"
        async="async"></script>
