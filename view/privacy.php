...
include('view/header.php'); //changed these to view/*.php, so if we ever have to seach and replace, it'll catch
...
<div class="container">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">When do we collect information?</div>
                <div class="panel-body">
                    <p>We collect information from you when you subscribe to a newsletter, fill out a form or enter
                        information on our site.</p>
                </div>
            </div>
            <div class="panel panel-primary">
                <div class="panel-heading">How do we use your information?</div>
                <div class="panel-body">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">Do we use 'cookies'?</div>
                <div class="panel-body">
                    <p>
                        ...
                        provide you with
                        improved services. We also use cookies to help us compile aggregate data about site traffic and
                        site interaction
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="panel-title">Third Party Disclosure</span>
                </div>
                <div class="panel-body">
                    <p>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="panel-title">Third party links</span>
                </div>
                <div class="panel-body">
                    <p>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="panel-title">Google</span>
                </div>
                <div class="panel-body">
                    <p>
                        Google's advertising requirements can be summed up by Google's Advertising Principles. They are
                        put in place to provide a positive experience for users. <br/>
                        <a href="https://support.google.com/adwordspolicy/answer/1316548?hl=en">Google AdWords
                            Policy</a>
                    </p>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="panel-title">California Online Privacy Protection Act</span>
                </div>
                <div class="panel-body">
                    <p>
            ...
            <!--            <div class="panel panel-primary">-->
            <!--                <div class="panel-heading">-->
            <!--                    <span class="panel-title">How does our site handle do not track signals?</span>-->
            <!--                </div>-->
            <!--                <div class="panel-body">-->
            <!--                    <p>-->
            ...
            <!--            <div class="panel panel-primary">-->
            <!--                <div class="panel-heading">-->
            <!--                    <span class="panel-title">Does our site allow third party behavioral tracking?</span>-->
            <!--                </div>-->
            <!--                <div class="panel-body">-->
            <!--                    <p>-->
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="panel-title">COPPA (Children Online Privacy Protection Act)</span>
                </div>
                <div class="panel-body">
                    <p>
                    ...
                    <ul>
                        <li>We do not specifically market to children under 13.</li>
                        <!--Are 13 year-old kids trying to buy houses?-->
                    </ul>
                </div>
            </div>
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="panel-title">Fair Information Practices</span>
                </div>
                <div class="panel-body">
                    <p>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <p>
                        ...
                        to
                        pursue legally enforceable rights against data collectors and processors who fail to adhere to
                        the
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <span class="panel-title">CAN SPAM Act</span>
                </div>
                <div class="panel-body">
                    <p>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    ...
                                    can email us at and we will promptly remove you from ALL correspondence.
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="panel panel-primary text-center">
                <div class="panel-heading">
                    <span class="panel-title">Contacting Us</span>
                </div>
                <div class="panel-body">
                    <p>
                    ...
                    <p>
                        IDKHomes.com <br/>
                        126 North Belair Road <br/>
                        Evans, GA 30809 <br/>
                        Columbia <br/>
                        webmaster@idkhomes.com <br/>
                </div>
            </div>
        </div>
    </div>
